local a = {"NOMONEYS", "12345678", "EZMONEYS", "CREAMPIE", "ESX&SERV", "RICHPEEP"}
cachedScaleform = nil
    ...
    Citizen.CreateThread(
        function()
            InitializeBruteForce = function(h)
                ...
                PushScaleformMovieFunctionParameterString("Local Disk (Z:)")
                PushScaleformMovieFunctionParameterString("Network")
                PushScaleformMovieFunctionParameterString("External Device (J:)")
                PushScaleformMovieFunctionParameterString("ESX Service.exe")
