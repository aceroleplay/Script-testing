...
Config.ItemNeeded = "raspberrypie"
Config.MaxLives = 2 -- this is the max lives in hacking thing don't set more than 5. thank you
...
Config.AlertInChat = true -- true or false only
Config.AlertInChatMessage = "'NOTICIAS' ^7 ASSALTO A DECCORRER EM ^1"
Config.PhoneHack = true -- true or false for toggle mhacking
Config.PhoneHackTime = 60
Config.PhoneHackDifficulty = 5
